...
When we did `str(surveys)` we saw that several of the columns are of class `numeric`. 
...
practice for dealing with date is to ensure that each component of your
